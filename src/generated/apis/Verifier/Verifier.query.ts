...
export const verifierApi = new VerifierApi({ customFetch: fetchExtended })
...
export const useVerifyPasswordMutation = (
  params: MutationHookParams<
    typeof verifierApi.verifyPassword,
    {
      error:
        | void
        | {
  ...
  const mutationKey = QUERY_KEY_VERIFIER_API.VERIFY_PASSWORD()
  return useMutation({
    mutationKey,
    mutationFn: verifierApi.verifyPassword,
    ...params?.options,
  })
}
